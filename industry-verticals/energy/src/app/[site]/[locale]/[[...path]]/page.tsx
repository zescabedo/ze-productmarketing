...
import { SearchAppProviders } from 'src/SearchAppProviders';
import { buildSitePageMetadata } from 'src/lib/site-page-metadata';
...
export default async function Page({ params, searchParams }: PageProps) {
  ...
  return (
    <NextIntlClientProvider>
      <SearchAppProviders locale={page.locale}>
        <Providers page={page}>
          <Layout page={page} />
        </Providers>
      </SearchAppProviders>
...
export const generateMetadata = async ({ params }: PageProps) => {
  ...
  return buildSitePageMetadata({ site, locale, path });
};
