...
export const componentMap = new Map<string, NextjsContentSdkComponent>([
  ...
  ['SocialFollow', { ...SocialFollow, componentType: 'client' }],
  ...
  ['FilterDropdown', { ...FilterDropdown, componentType: 'client' }],
  ...
  ['DestinationDetails', { ...DestinationDetails, componentType: 'client' }],
  ['Deals', { ...Deals, componentType: 'client' }],
